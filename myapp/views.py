...
def sendkey(request, id):
    ...
    data.save()
    email_subject = 'Secure Decryption Key for Your Requested File'
    email_message = f'Dear {data.requester},\n\nWelcome to Cloud Security Website!\n\nYour request for the encrypted file has been approved.\n\nHere are your decryption Key details:\nBelow is your Email: {data.requester}\nBelow is your secure decryption key: {data.otp}\n\nPlease use this key to decrypt your file securely.\n\nBest regards,\nCloud Security Team'
    send_mail(email_subject, email_message, 'tvakatarao@gmail.com', [data.requester])
    messages.success(request, 'Decryption key successfully sent to your Email')
    return redirect('viewrequests')
